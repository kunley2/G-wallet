...
class CreateAccountForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('phone_number','date_of_birth','passcode','photo','first_name','last_name')
        widget = {
    ...
    def __init__(self,*args, **kwargs):
        ...
        self.fields["first_name"].widget.attrs['class'] = "bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
        self.fields["first_name"].widget.attrs['placeholder'] = 'Tonks'

        self.fields["last_name"].widget.attrs['class'] = "bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
        self.fields["last_name"].widget.attrs['placeholder'] = 'Dex'
